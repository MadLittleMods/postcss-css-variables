System.config({
  ...
  "bundles": {
    "build": [
      ...
      "npm:postcss@4.1.8/lib/warn-once",
      ...
      "npm:postcss@4.1.8/lib/warning",
      "npm:postcss@4.1.8/lib/tokenize",
      "npm:postcss@4.1.8/lib/comment",
      "npm:postcss@4.1.8/lib/list",
      "npm:postcss@4.1.8/lib/root",
      "github:jspm/nodelibs-fs@0.1.2/index",
      "npm:es6-promise@2.1.1/dist/es6-promise",
      "npm:postcss@4.1.8/package.json!github:systemjs/plugin-json@0.1.0",
      "npm:postcss@4.1.8/lib/vendor",
      ...
      "npm:keymirror@0.1.1",
      "npm:events@1.0.2",
      "npm:postcss@4.1.8/lib/css-syntax-error",
      "npm:base64-js@0.0.8",
      "npm:ieee754@1.1.4",
      "npm:is-array@1.0.1",
      ...
      "npm:postcss@4.1.8/lib/result",
      "npm:postcss@4.1.8/lib/rule",
      ...
      "npm:postcss@4.1.8/lib/node",
      "npm:buffer@3.2.1/index",
      ...
      "npm:flux@2.0.3",
      "npm:postcss@4.1.8/lib/declaration",
      "npm:buffer@3.2.1",
      ...
      "npm:postcss@4.1.8/lib/map-generator",
      "npm:react@0.13.2",
      "npm:postcss@4.1.8/lib/lazy-result",
      "npm:postcss@4.1.8/lib/processor",
      "npm:postcss@4.1.8/lib/postcss",
      "npm:postcss@4.1.8",
